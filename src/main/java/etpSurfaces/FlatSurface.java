...
public class FlatSurface implements TranspiringSurface{
	...
	/*	public void setDelta(double leafTemperature) { this.leafTemperature = leafTemperature; 
		public void setSurfaceTemperature(double leafTemperature) { this.leafTemperature = leafTemperature; 
		public void setSurfaceTemperature(double leafTemperature) { this.leafTemperature = leafTemperature; 
		public void setSurfaceTemperature(double leafTemperature) { this.leafTemperature = leafTemperature; 
		public void setSurfaceTemperature(double leafTemperature) { this.leafTemperature = leafTemperature; 
		public void setSurfaceTemperature(double leafTemperature) { this.leafTemperature = leafTemperature; 
		...
		//	System.out.println("la T della classe	"+leafTemperature);
		
}*/


		public FlatSurface () {/*double delta,double leafTemperature, double airTemperature, double latentHeatTransferCoefficient,
		...
		public double incidentSolarRadiation() {
			double incidentSolarRadiationLight = shortWaveRadiationDirect + shortWaveRadiationDiffuse;
