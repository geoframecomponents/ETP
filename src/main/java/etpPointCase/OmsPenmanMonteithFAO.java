...
public class OmsPenmanMonteithFAO {
    ...
    public void process() throws Exception {
		...
		//	System.out.println(waterStressCoefficient);
            ...
            WindProfile windSpeedWithZ = new WindProfile();
            PenmanMonteithFAO FAO = new PenmanMonteithFAO();
            WaterStress waterStress = new WaterStress();
      
            waterStress.setParams(etp, soilMosture, etp, totalAvailableWater, readilyAvailableWater);
            waterStress.totalAvailableWater();
            waterStress.rootZoneDepletation();
            waterStress.readilyAvailableWater();
            System.out.println("TAW from main");
	    	System.out.println(waterStress.totalAvailableWater);

            System.out.println("RAW from main");
	    	System.out.println(readilyAvailableWater);
	    	System.out.println("RAW from component");
	    	System.out.println(rawCom);

//            windSpeedWithZ.setParams(height, windSpeed);
